...
<svelte:head>
	<title>Quizzy/docs - Attribution</title>
	<meta name="description" content="People who helped making with Quizzy." />
</svelte:head>
<article
...
>
	...
	<h2>Translators</h2>
	<p>
		People who translated Quizzy on <a href="https://translate.mawoka.eu/engage/classquiz/"
			>Weblate</a
		> or directly.
	</p>
	<ul>
	...
	<h1>Rules</h1>
	<p>
		If you are listed once here, you're a part of Quizzy, forever! <br />
