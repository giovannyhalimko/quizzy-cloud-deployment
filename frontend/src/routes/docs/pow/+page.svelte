...
<svelte:head>
	<title>Quizzy/docs - PoW</title>
	<meta
		name="description"
		content="Use-case of PoW for Quizzy, the open-source quiz-application"
	/>
</svelte:head>
<article
...
>
	...
	<p>
		...
		using your CPU. It's mainly used in crypto-stuff, but not in Quizzy. It's just used to
