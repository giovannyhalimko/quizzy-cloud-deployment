...
<svelte:head>
	<title>Quizzy/docs - Terms of Service</title>
	<meta
		name="description"
		content="The terms of service of Quizzy, the open-source quiz-application"
	/>
</svelte:head>
...
>
	...
	<h2>What doesn't belong on Quizzy</h2>
	<p>
	...
	<p>
		...
		rule or not. Quizzy also doesn't provide any (uptime)-guarantee, so Quizzy could be shut down
		without any warning and without any ability for the user to get their data. The admin may publish
		any data provided by the user anywhere and share it with anyone.
	</p>
	<h2>The rights of the user</h2>
	<p>
		You can request the deletion of your data at any time by writing an email to
		deleteme@mawoka.eu. Please include the email you registered with on Quizzy, and, if
		possible, a prove that you are the owner of the account, by, eg., writing the email with the
		email-address which is associated with your Quizzy-account.
	</p>
