...
<svelte:head>
	<title>Quizzy/docs - Development-setup</title>
	<meta
		name="description"
		content="How to import quizzes from KAHOOT! into Quizzy, the open-source quiz-application,  easily"
	/>
</svelte:head>
<article
...
>
	...
	<ul>
		<li>
			Clone the repo:
			<pre><code>git clone https://github.com/mawoka-myblock/Quizzy</code></pre>
		</li>
		<li>
		...
		<li>
			...
			<p>
				...
				to run Quizzy. The standard workflow is the following:
			</p>
			<ol>
				<li>
		...
		<li>
			Add the following line to your <code>/etc/hosts</code>-file, so you can visit Quizzy via
			<code>test.com</code>
			(Required for the Captcha and Mapbox)
			<pre><code>127.0.0.1 test.com</code></pre>

			Now you can visit Quizzy at<a href="http://test.com:8080" rel="nofollow" target="_blank"
				>http://test.com:8080</a
			>.
		</li>
		<li>
