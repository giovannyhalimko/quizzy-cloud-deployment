...
<svelte:head>
	<title>Quizzy/docs - Self-Host</title>
	<meta name="description" content="How to self-host Quizzy, the open-source quiz-application" />
</svelte:head>
<article
	class="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto mt-10 prose-slate px-4 dark:prose-invert"
>
	<h1>Self-Hosting</h1>
	<p>Since Quizzy is open-source, it can also be self-hosted.</p>
	...
	<pre><code class="language-bash"
			>git clone https://github.com/mawoka-myblock/classquiz && cd Quizzy</code
		></pre>
	<p>
	...
	<p>
		...
		be scaled and the media doesn't have to streamed through the (comparatively) slow Quizzy
	...
	<p>
		...
		JavaScript origin", which is just the base-domain (with https) of your Quizzy-installation. Then,
		add a new "Authorised redirect URI". This URI will have the following scheme:
	</p>
	...
	<p><b>Quizzy needs HTTPS/SSL to work properly!</b></p>
	<p><b>Enjoy! ❤️</b></p>
</article>
