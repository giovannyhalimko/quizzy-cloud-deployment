...
<svelte:head>
	<title>Quizzy - {$t('index_page.meta.title')}</title>
	<meta name="description" content={$t('index_page.meta.description')} />
	<title>Quizzy - Home</title>
	<meta
		name="description"
		content="Quizzy is a quiz-application like KAHOOT!, but open-source. You can create quizzes and play them remotely with other people."
	/>

	<meta property="og:url" content="https://classquiz.de/" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Quizzy - {$t('index_page.meta.title')}" />
	<meta
	...
	<meta name="twitter:title" content="Quizzy - {$t('index_page.meta.title')}" />
	<meta
...
<!--<div class="min-h-screen flex flex-col">
	<section class="pb-40">
		<div class="pt-12 text-center">
			<h1 class="sm:text-8xl text-6xl mt-6 marck-script">Quizzy</h1>
